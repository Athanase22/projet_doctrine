...
<body>
    ...
    <div class="container">
        ...
        <a href="update.php?id=<?= $enseignant ? $enseignant->getId() : " " ?>" class="btn btn-warning btn-sm">Editer</a>
        <table class="table table-condensed table-striped">
            <tr>
                <td>nom</td>
                <td><?= $enseignant ? $enseignant->getNom() : " " ?></td>
            </tr>
            <tr>
                <td>Prenom</td>
                <td><?= $enseignant ? $enseignant->getPrenom() : " " ?></td>
            </tr>
                <td>contact</td>
                <td><?= $enseignant ? $enseignant->getContact() : " " ?></td>
            </tr>
        </table>
    </div>
