        ...
        <table class="table table-condensed table-striped">
            ...
            <?php foreach ($etudiants as $etudiant) : ?>
                <tr>
                    ...
                    <td>
                        <a href="detail.php?id=<?= $etudiant->getId() ?>" class="btn btn-sm btn-success">Détails</a>
                        <a href="update.php?id=<?= $etudiant ? $etudiant->getId() : " " ?>" class="btn btn-sm btn-warning">Editer</a>
