    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                <a class="nav-link" href="index.php">Filiere</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        ...
        <table class="table table-condensed table-striped">
            ...
            <?php foreach ($filieres as $filiere) : ?>
                <tr>
                    <td><?= $i ?></td>
                    <td><?= $filiere->getLibelle() ?></td>
                    <td>
                        <a href="detail.php?id=<?= $filiere->getId() ?>" class="btn btn-sm btn-success">Détails</a>
                        <a href="update.php?id=<?= $filiere ? $filiere->getId() : " " ?>" class="btn btn-sm btn-warning">Editer</a>

                        <form action="save.php" method="post" style="display:inline" id="delete">
                            <input type="hidden" name="id" value="<?= $filiere ? $filiere->getId() : " " ?>">
