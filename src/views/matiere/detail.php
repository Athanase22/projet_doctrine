...
<body>
    ...
    <div class="container">
        ...
        ?>
        <h1>Detail des matieres</h1>
        <a href="index.php" class="btn btn-primary btn-sm">Liste</a>
        <a href="update.php?id=<?= $matiere ? $matiere->getId() : " " ?>" class="btn btn-warning btn-sm">Editer</a>
        <table class="table table-condensed table-striped">
            <tr>
                <td>libelle</td>
                <td><?= $matiere ? $matiere->getLibelle() : " " ?></td>
            </tr>
            <tr>
                <td>Credit</td>
                <td><?= $matiere ? $matiere->getCredit() : " " ?></td>
            </tr>
        </table>
    </div>
