        ...
        <table class="table table-condensed table-striped">
            ...
            <?php foreach ($matieres as $matiere) : ?>
                <tr>
                    ...
                    <td>
                        <a href="detail.php?id=<?= $matiere->getId() ?>" class="btn btn-sm btn-success">Détails</a>
                        <a href="update.php?id=<?= $matiere ? $matiere->getId() : " " ?>" class="btn btn-sm btn-warning">Editer</a>
